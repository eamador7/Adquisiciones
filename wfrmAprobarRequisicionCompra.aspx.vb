Imports System.Data
Partial Class wfrmAprobarRequisicionCompra
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            dt.Columns.AddRange(New DataColumn(7) {New DataColumn("numrequisicion"), New DataColumn("solicitante"), New DataColumn("departamento"), New DataColumn("estatus"), New DataColumn("fecha"), New DataColumn("intidestatus"), New DataColumn("intdepartamento"), New DataColumn("seleccionar")})
        ...
        Try
            If grvProducto.Rows.Count > 0 Then
                ...
                strMensaje = clsFunciones.EjecutaProcedimiento("MIGRACION", "Actualiza_Estatus_RequisicionCompra", _
                            ViewState("Solicitudes").Rows(0).item(0) & "," & filterEstatus.Trim & "," & Session("IdUsuario") & ",Normal", _
                            "@intRequisicion,@intEstatus,@intIdUsuarioCaptura,@vchComentarios")
                'strMensaje = "OK"
                If strMensaje = "OK" Then
                    Alert("Requisicion de compra RE" & ViewState("Productos").Rows(0).item(0) & " aprobada con exito")
                    'Dim i As Integer
                    ...
                    Timer1.Enabled = True
                Else
                    Alert("Error al aprobar la requisicion RE" & ViewState("Productos").Rows(0).item(0) & ": " & strMensaje)
                End If
            Else
                Alert("Favor de seleccionar Requisicion de compra a aprobar")
            End If
    ...
    Protected Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        Response.Redirect("wfrmAprobarRequisicionCompra.aspx?key=" & Request.QueryString("key").Replace("+", "%2B"))
    End Sub
