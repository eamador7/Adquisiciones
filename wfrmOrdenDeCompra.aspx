<%@ Page Language="VB" MasterPageFile="MPCompras.master"  AutoEventWireup="false" CodeFile="wfrmOrdenDeCompra.aspx.vb" Inherits="wfrmOrdenDeCompra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">   
		...
		<div class="panel-body">
			...
			<div class="row">   
				<div class="form-group col-lg-2 col-md-2 col-sm-2"> 
					...
					<asp:TextBox ID="txtProveedor" ReadOnly="true" class="form-control" runat="server" ToolTip="No. Proveedor" placeholder="No. Proveedor"></asp:TextBox>                
				</div>          
				  <div class="form-group col-lg-4 col-md-4 col-sm-4"> 
					 <asp:label ID="Label3" runat="server">NOMBRE PROVEEDOR:</asp:label> 
	...
	<div class="panel panel-success">
		<div class="row panel-body" style="color:black;padding-bottom: 0px;">
			...
			<div class="form-group col-lg-2 col-md-2 col-sm-2">
				<asp:TextBox ID="txtPrecio" runat="server" class="form-control" style="text-align:right" ToolTip="Precio" placeholder="Precio"></asp:TextBox>                                          
			</div>  
			<div class="form-group col-lg-2 col-md-2 col-sm-2">
				<asp:TextBox ID="txtCantidad"   runat="server"  class="form-control" style="text-align:right" ToolTip="Cantidad" placeholder="Cantidad"></asp:TextBox>                                          
			</div>                                                            
		</div>
		<div class="row panel-body" style="color:black;padding-top: 0px;">
		  ...
		  <div class="form-group col-lg-5 col-md-5 col-sm-5"> 
				<asp:TextBox ID="txtAdicional" runat="server" class="form-control" ToolTip="Descripcion adicional" placeholder="Descripcion adicional del articulo"></asp:TextBox>
			</div> 
			<div class="form-group col-lg-1 col-md-1 col-sm-1"> 
			...
			<div class="col-md-12">
				<asp:GridView ID="grvDetOrden" class="table" runat="server" AutoGenerateColumns="false">   
					...
					<Columns>    
						...
						<asp:BoundField DataField="precio" HeaderText="PRECIO"/>
						<asp:BoundField DataField="totalart" HeaderText="TOTAL ARTICULO"/>
	...
	<div class="row panel-body" style="color:black">
		...
		<div class="form-group col-lg-2 col-md-2 col-sm-2"> 
					...
					<asp:TextBox ID="txtTotal" ReadOnly="true" class="form-control" style="text-align:right" runat="server" ToolTip="Total" placeholder="Total"></asp:TextBox>                
				</div> 
		<div class="form-group col-lg-2 col-md-2 col-sm-2" style="color:rgba(250, 184, 28, 0.50)">
			<asp:Button ID="btnGuardar" runat="server"  Text="Guardar Orden" class="btn btn-default" />                
		</div> 
	</div>
 <script>
