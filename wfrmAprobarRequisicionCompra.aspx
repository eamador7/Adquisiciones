<%@ Page Language="VB" MasterPageFile="MPCompras.master" AutoEventWireup="false" CodeFile="wfrmAprobarRequisicionCompra.aspx.vb" Inherits="wfrmAprobarRequisicionCompra" %>
    ...
    <asp:Timer ID="Timer1" runat="server" Enabled="false" Interval="2000"></asp:Timer>
        <div class="panel panel-success">
         ...
         <div class="row panel-body" style="color:black">
            ...
            <div class="form-group col-lg-2 col-md-2 col-sm-2" style="color:rgba(250, 184, 28, 0.50)">
                <asp:Button ID="btnAprobar" runat="server"  Text="Aprobar Requisición" class="btn btn-default" />                
            </div> 
        </div>
