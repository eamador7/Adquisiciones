<%@ Page Language="VB" MasterPageFile="MPCompras.master" AutoEventWireup="false" CodeFile="wfrmSolicitudesAprobadas.aspx.vb" Inherits="wfrmSolicitudesAprobadas" %>
        ...
        <div class="panel panel-success">
            <div class="panel-body">
                ...
                <%--     <div class="form-group col-lg-2 col-md-2 col-sm-6">
                        <asp:label ID="Label1" runat="server">Solicitud:</asp:label>
                        <asp:TextBox ID="txtSolicitud" TextMode="Number" class="form-control" runat="server" ToolTip="Requisicion" placeholder="Requisicion"></asp:TextBox>                
                    </div>--%>
            ...
            <div class="row">
                <div class="col-md-12">
                    <asp:GridView ID="grvSolicitudes" class="table tbl-sel" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="True">   
                        ...
                        <Columns>                                                                
                            <asp:BoundField DataField="numsolicitud" HeaderText="# SOLICITUD"/>                        
                ...
                <div class="form-group col-lg-6 col-md-6 col-sm-6">
                     ...
                     <asp:TextBox ID="txtServicio" ReadOnly="true" TextMode="MultiLine" class="form-control" runat="server" ToolTip="Servicio solicitado" placeholder="Servicio solicitado"></asp:TextBox>                                        
                </div>
            </div>
<%--            <div class="row">
                <div class="col-md-1">
       ...
       <%--      <div class="form-group col-lg-2 col-md-2 col-sm-2" style="color:rgba(250, 184, 28, 0.50)">
            ...
            <div class="form-group col-lg-2 col-md-2 col-sm-2" style="color:rgba(250, 184, 28, 0.50)">
                <asp:Button ID="btnAprobar" runat="server"  Text="Agregar Requisicion" class="btn btn-default" />                
            </div> 
        </div>
